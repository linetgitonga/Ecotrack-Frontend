...
import '../data/remote/api/account_api.dart' as _i484;
...
import '../features/account/presentation/bloc/consent_cubit.dart' as _i100;
...
import '../features/alerts/presentation/bloc/alerts_cubit.dart' as _i533;
import '../features/auth/presentation/bloc/auth_bloc.dart' as _i59;
import '../features/automation/presentation/bloc/automation_cubit.dart'
    as _i307;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i484.AccountApi>(
      () => _i484.AccountApi(gh<_i101.ApiClient>(instanceName: 'cloud')),
    );
    ...
    gh.factory<_i533.AlertsCubit>(
      () => _i533.AlertsCubit(gh<_i258.TierBApi>()),
    );
    gh.factory<_i307.AutomationCubit>(
      () => _i307.AutomationCubit(gh<_i258.TierBApi>()),
    );
