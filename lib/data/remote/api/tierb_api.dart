...
class TierBApi {
  ...
  Future<Result<List<Map<String, dynamic>>>> hubs() => _client
      .get<List<Map<String, dynamic>>>(ApiPaths.hubs, parse: ApiEnvelope.list);
  ...
  static String _ruleSummary(Map<String, dynamic> e) {
    final t = e['trigger'];
    if (t is! Map) return 'Automation rule';
    return switch (t['type']) {
      'mode_enter' => 'When entering ${t['mode_key']} mode',
      'power' => 'On sustained high power',
